...
namespace TPW.Sim
{
    ...
    public enum Purpose
    {
        ...
        Turnstile11 = 11,
        Turnstile12 = 12,
        /// <summary>Arrived somewhere pleasant: back to Idle, sometimes with a sound.</summary>
        Pleased = 13,
        Turnstile14 = 14,
        Turnstile15 = 15,
        Turnstile16 = 16,
    ...
    public enum Arrival
    {
        ...
        EmptiedRubbish,
        LeftThePark,
        /// <summary>A turnstile purpose (11-16). §2.6 is not built, so these are refused rather than
        /// half-implemented.</summary>
        TurnstileNotBuilt,
    }

    /// <summary>What arrival needs of the park.</summary>
    public interface IArrivalWorld
    {
        long NowTick { get; }
    ...
    public static class VisitorArrival
    {
        ...
        static Arrival Act(Visitor guest, IArrivalWorld world, IRandomSource rng) => guest.Purpose switch
        {
            ...
            Purpose.Turnstile11 or Purpose.Turnstile12 or Purpose.Turnstile14
                or Purpose.Turnstile15 or Purpose.Turnstile16 => Arrival.TurnstileNotBuilt,
        ...
        {
            rng.Next(PleasedSoundChanceIn);   // the sound roll happens whether or not audio is wired
            return Idle(guest);
        }
