...
namespace TPWGodot
{
    ...
    sealed class ParkRideWorld : IQueueWorld
    {
        ...
        // ⚠ SHOPS AND SIDESHOWS ARE NOT WIRED. The purchase routines are ported (TPW.Sim.VisitorPurchase)
        // but this world does not implement IShopWorld yet, so a shop sells nothing and takes no money.
        // Both are stubs and say so, rather than quietly returning a plausible number.
